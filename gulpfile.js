...
var webpackCordovaConfig = require("./webpack.config.cordova.production");
var testPlatform = 'browser';

var cordovaBuildDir = path.join(__dirname, 'build-cordova');
var platformDirs = [
    path.join(__dirname, 'node_modules', 'cordova-browser'),
    /*path.join(__dirname, 'node_modules', 'cordova-ios'),*/
    /*path.join(__dirname, 'node_modules', 'cordova-android'),*/
]; // List of subdirs with platform files under node_modules
